...
public class WikiBase {
	...
	private static final String CACHE_PARSED_TOPIC_CONTENT = "org.jamwiki.WikiBase.CACHE_PARSED_TOPIC_CONTENT";
	/** The topics are stored in a flat file */
	private static final int PERSISTENCE_INTERNAL_DB = 0;
	/** The topics are stored in a database */
	private static final int PERSISTENCE_EXTERNAL_DB = 1;
	/** Root directory within the WAR distribution that contains the default topic pages. */
	static public final String SPECIAL_PAGE_DIR = "pages";
	/** Name of the default starting points topic. */
	//private static final String SPECIAL_PAGE_STARTING_POINTS = "StartingPoints";
	/** Name of the default left menu topic. */
	private static final String SPECIAL_PAGE_LEFT_MENU = "LeftMenu";
	/** Name of the default footer topic. */
	private static final String SPECIAL_PAGE_BOTTOM_AREA = "BottomArea";
	/** Name of the default jamwiki.css topic. */
	private static final String SPECIAL_PAGE_SPECIAL_PAGES = "SpecialPages";
	/** Name of the default jamwiki.css topic. */
	...
	static final String USER_HANDLER_DATABASE = "org.jamwiki.db.DatabaseUserHandler";
